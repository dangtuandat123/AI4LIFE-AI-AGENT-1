...
class RouterResponse(BaseModel):
    agent_current: Literal["node_get_schema", "router_agent", "planner_agent", "query_agent", "final_agent"] = Field(description="agent hiện tại đang thực thi.")
    next_agent: Literal["planner_agent", "final_agent", "query_agent"] = Field(description="agent tiếp theo sẽ thực hiện.")
