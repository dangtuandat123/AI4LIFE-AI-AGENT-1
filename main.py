...
if __name__ == "__main__":
    sample_report = (
        ...
        "Hôm nay em hoàn thành 5 đơn hàng (doanh thu ~ 120 triệu VND) cho dự án A, chi hết 3 triệu quảng cáo Facebook. "
    )
    # sample_report = (
    #     """Nhân viên 11111111-1111-1111-1111-111111111111 thuộc team finance. 
    #     Bán được vài đơn hàng, doanh thu khoảng 100k. 
    #     """
    # )
